...
-- Joseph Mensah (DOB 8/11/2001) registered once under Dragons RL only.
-- ============================================================

-- Step 0: temp staging table
...
-- ── Step 2: Insert players (status active) + collect IDs ────

-- ACCRA PANTHERS (23 players)
...
ins as (
  ...
  select t.team_id,p.fn,p.ln,p.dob::date,'active','male'
  from team t,
  (values
...
-- DRAGONS RL (27 players — Joseph Mensah counted once here, removed from Tigers)
...
ins as (
  ...
  (values
    ...
    ('Prince',      'Chris Ebo Da-Gama',    '1993-10-17'),
...
-- NUNGUA TIGERS (22 players — Joseph Mensah 8/11/2001 removed; already in Dragons)
...
-- ── Step 3: Register all for 2026 + set active ──────────────
...
-- Ensure all imported players are marked active
